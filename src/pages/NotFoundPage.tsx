    ...
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center px-8 text-center">
      ...
      >
        ...
        >
          ...
          <path d="M18 18 L26 34" stroke="#444" strokeWidth="3.5" strokeLinecap="round" />
          <path d="M33 18 L41 34" stroke="#444" strokeWidth="3.5" strokeLinecap="round" />
          <path d="M48 18 L56 34" stroke="#444" strokeWidth="3.5" strokeLinecap="round" />
          <path d="M63 18 L71 34" stroke="#444" strokeWidth="3.5" strokeLinecap="round" />
          <text x="48" y="68" textAnchor="middle" fill="#ef4444" fontSize="22" fontWeight="bold" fontFamily="monospace">404</text>
        </svg>
      </motion.div>
